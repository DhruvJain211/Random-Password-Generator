    ...
    <>
      <div className="flex flex-col min-h-screen bg-gray-950 items-center justify-center">
        ...
        <footer className="fixed bottom-0 w-full bg-gray-800 text-white text-center py-3 px-5 flex items-center justify-between font-mono">
          <p className="">Dhruv Jain</p>
          <div>
            <ul className="nav-social-logo">
              <li>
                <a href="https://github.com/DhruvJain211">
                  DhruvJain211
                </a>
              </li>
              <div className="vertical-line"></div>
              <li>
                <a href="https://github.com/DhruvJain211" className="github-logo">
                  <svg
              ...
              <li>
                <a href="https://www.linkedin.com/in/dhruv-jain-6bab97252/" className="linkedin-logo">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <li>
                <a href="http://instagram.com/_dhruv_224_" className="instagram-logo">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <li>
                <a href="http://twitter.com/DhruvJain224" className="twitter-logo">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
